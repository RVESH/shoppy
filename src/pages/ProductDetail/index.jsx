  ...
  if (!product) {
    return (
      <div className="pdNotFound">
        ...
        {onBack && <button className="pdBackBtn" onClick={onBack}>← Go Back</button>}
      </div>
    );
  }
    ...
    <div className="pdPage">
      ...
      <div className="pdBreadcrumb">
        <div className="pdBreadcrumbInner">
          {onBack && (
            <button className="pdBackBtn" onClick={onBack}>← Go Back</button>
          )}
        ...
        <div className="pdMainInner">
          ...
          <div className="pdInfoSection">
            ...
            <div className="pdPriceBox">
              ...
              {product.mrp > product.price && (
                <>
                  ...
                  <span className="pdSaving">Save ₹{product.mrp - product.price}!</span>
                </>
              )}
              {product.isService && (
            ...
            <div className="pdActions">
              ...
              >
                {addedToCart ? "✓ Added to Cart!" : product.isService ? "🖨️ Book Service" : "🛒 Add to Cart"}
              </button>
      ...
      {related.length > 0 && (
        <div className="pdRelated">
          <div className="pdRelatedInner">
            <h2 className="pdRelatedTitle">More Products From This Category 👇</h2>
