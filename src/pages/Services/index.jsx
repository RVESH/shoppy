  ...
  return (
    <div className={`serviceCard ${expanded ? "serviceCardExpanded" : ""}`}>
      ...
      <div className="scActions">
        <button className="scViewBtn" onClick={() => onOpen(service)}>🔍 Details Dekho</button>
    ...
    <div className="servicesPage">
      ...
      <div className="srvPageHeader">
        <div className="srvPageHeaderInner">
          ...
          <p className="srvPageSubtitle">PAN card se resume tak — sab kuch ek hi jagah, turat service!</p>
      ...
      <div className="srvGrid">
        <div className="srvGridInner">
          ...
          {loading ? (
            <div style={{textAlign:"center",padding:"60px",color:"#78716c"}}>⏳ Services load ho rahi hain...</div>
          ) : (
      ...
      <div className="srvCta">
        <div className="srvCtaInner">
          ...
          <p className="srvCtaSubtitle">List mein nahi hai? Koi baat nahi — WhatsApp pe poochho!</p>
