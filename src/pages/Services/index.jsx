...
const services = allProducts.filter((p) => p.isService);
    ...
    <div className="servicesPage">
      ...
      <div className="srvFilterBar">
        <div className="srvFilterBarInner">
          ...
          >
            🗂️ All Services
            <span className="srvFilterCount">{services.length}</span>
          </button>
      ...
      <div className="srvCta">
        <div className="srvCtaInner">
          ...
          <p className="srvCtaSubtitle">
            List mein nahi hai? Koi baat nahi — WhatsApp pe poochho, hum try karenge!
          </p>
          <a
            href="https://wa.me/919999999999"
            target="_blank"
            rel="noreferrer"
            className="srvCtaWaBtn"
          >
