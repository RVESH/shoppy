...
export default function Categories() {
  // ✅ CHANGE 1: Removed data/index.js import — now comes from API
  ...
  // ✅ CHANGE 2: Added useEffect — fetch data from PHP API
  useEffect(() => {
    ...
    <div className="categoriesPage">
      ...
      <div className="catPageHeader">
        <div className="catPageHeaderInner">
          ...
          <h1 className="catPageTitle">All Categories 🗂️</h1>
          ...
          {search && (
            <p className="catSearchResult">{totalVisible} items found for "{search}"</p>
          )}
        </div>
      </div>
      ...
      <div className="catControls">
        <div className="catControlsInner">
          <span className="catControlsInfo">
            <strong>{totalVisible}</strong> items are visible
          </span>
          <div className="catControlsBtns">
            <button className="ctrlBtn" onClick={expandAll}>↓ Expand All</button>
            <button className="ctrlBtn" onClick={collapseAll}>↑ Collapse All</button>
          </div>
        </div>
      </div>

      {/* ✅ CHANGE 3: Added loading state */}
